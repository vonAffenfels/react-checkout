...
const Spin = ({w = 5, h = 5, className, style = {}}: {w?: number, h?: number, className?: string, style?: React.CSSProperties}) => (
    <svg
...
const SpinButton = ({className}: {className?: string,}) => (
    <svg role="status" className={`inline w-4 h-4 text-white animate-spin ${className || ""}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
